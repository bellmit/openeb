...
public class RedisServiceTest {
	...
	public void ssdnDelList(){
		...
		OrderItem item = (OrderItem) ssdbTemplate.boundListOps(key).index(0);
	...
	public void addListObject() {
		...
		ListOperations<String, Category> ops = redisTemplate.opsForList();
	...
	public void getListObject() {
		ListOperations<String, Category> ops = redisTemplate.opsForList();
		List<Category> cateList = ops.range("c-list", 0, -1);
