    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="/website/index/forward?id=0&amp;type=mobile_list"><span>新增楼层</span></a></li>
            </ul>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr class="hover" style="background: rgb(255, 255, 255);">
                ...
                <td class="w150 align-center">
                    <a href="/website/index/forward?id=${floor.id }&amp;type=mobile_list">编辑</a>|
                    <a href="/website/index/delete?id=${floor.id }">删除</a></td>
            </tr>
            </c:forEach>
        </tbody>
    </table>
