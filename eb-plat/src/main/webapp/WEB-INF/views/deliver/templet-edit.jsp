...
<link href="./管理后台-运费模板修改_files/font-awesome.min.css" rel="stylesheet">
<script type="text/javascript" src="./管理后台-运费模板修改_files/jquery.ui.js"></script>
<script type="text/javascript" src="./管理后台-运费模板修改_files/zh-CN.js" charset="utf-8"></script>
<link rel="stylesheet" type="text/css" href="./管理后台-运费模板修改_files/jquery.ui.css">
<script type="text/javascript" src="./管理后台-运费模板修改_files/common_select.js" charset="utf-8"></script>
<script type="text/javascript" src="./管理后台-运费模板修改_files/dialog.js" id="dialog_js" charset="utf-8"></script><link href="./管理后台-运费模板修改_files/dialog.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="./管理后台-运费模板修改_files/dialog.css">
<script type="text/javascript" src="./管理后台-运费模板修改_files/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="./管理后台-运费模板修改_files/jquery.mousewheel.js"></script>
<!-- css -->
<link href="./管理后台-运费模板修改_files/member_store.css" rel="stylesheet" type="text/css">
<link href="./管理后台-运费模板修改_files/member.css" rel="stylesheet" type="text/css">
<link href="./管理后台-运费模板修改_files/base.css" rel="stylesheet" type="text/css">
<link href="./管理后台-运费模板修改_files/transport.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="./管理后台-运费模板修改_files/jquery.js"></script>
<script type="text/javascript" charset="utf-8" src="./管理后台-运费模板修改_files/jquery.validation.min.js"></script>
<script src="./管理后台-运费模板修改_files/layer.js"></script><link rel="stylesheet" href="./管理后台-运费模板修改_files/layer.css" id="layui_layer_skinlayercss">
<script type="text/javascript">
var BASE_PATH = '/leimingtech-admin';
var transportId = '777a6c76f2b648c8bb4985d7c4b30097';
</script>
</head>
<body>
					...
					<form method="post" id="tpl_form" name="tpl_form" action="javascript:void(0);">
						...
						<div class="postage-tpl-head">
							<ul>
								...
								<input type="text" class="text" autocomplete="off" value="测试" name="title" style="height: 18px;width: 123px; margin-top: 0px;">
						...
						<div class="postage-tpl" id="kd">
							<p class="trans-line">
								<input id="Deliverykd" type="checkbox" value="kd" name="tplType[]" checked="checked"> <label for="Deliverykd">快递</label>
							</p>
...
<input class="J_BatchField" style="width:15px;display:none" type="checkbox" value="" name="kd_n1">
<p>海南省</p></span>
<input type="hidden" value="46,4601,4602,4690|||海南省" name="areas[kd][1]">
</td>
<td>
<input class="input-text text" type="text" aria-label="首件" maxlength="4" autocomplete="off" value="1" data-field="start" name="special[kd][1][start]">
</td>
<td>
<input class="w50 mr5 text" type="text" aria-label="首费" maxlength="6" autocomplete="off" value="" data-field="postage" name="special[kd][1][postage]">
</td>
<td>
<input class="input-text text" type="text" aria-label="续件" maxlength="4" autocomplete="off" value="1" data-field="plus" name="special[kd][1][plus]">
</td>
<td>
<input class="w50 mr5 text" type="text" aria-label="续费" maxlength="6" autocomplete="off" value="" data-field="postageplus" name="special[kd][1][postageplus]">
</td>
<td>
...
<p>市辖区,广州市</p></span>
<input type="hidden" value="1101,4401|||市辖区,广州市" name="areas[kd][2]">
</td>
<td>
...
<a class="J_DeleteRule" href="JavaScript:void(0);">删除</a>
	...
	<script type="text/javascript" src="./管理后台-运费模板修改_files/transport.js" charset="utf-8">
var BASE_PATH = '/leimingtech-admin';
var transportId = '777a6c76f2b648c8bb4985d7c4b30097';
</script>
<script>
	...
	$('div[class="postage-tpl"]').each(function(){
		...
		var tag = 0;
			if ('kd' == tplType){
				...
				if (',46,4601,4602,4690,' == ''){
					var cur_tr = $(this).find('.tbl-except').prev();
					$(cur_tr).find('input[data-field="start"]').attr("value","1");
					$(cur_tr).find('input[data-field="postage"]').val('20');
					$(cur_tr).find('input[data-field="plus"]').val('1');
					$(cur_tr).find('input[data-field="postageplus"]').val('20');
					tag ++;
				}else{
					StartNum +=1;
					...
					$(cur_tr).find('.area-group>p').html('海南省');
					var area = ',46,4601,4602,4690,';
					area = area.substring(1,area.length-1);
					$(cur_tr).find('input[type="hidden"]').val(area + '|||' + '海南省');
					$(cur_tr).find('input[data-field="start"]').val('1');
					$(cur_tr).find('input[data-field="postage"]').val('20');
					$(cur_tr).find('input[data-field="plus"]').val('1');
					$(cur_tr).find('input[data-field="postageplus"]').val('20');
					tag ++;
			...
			if ('kd' == tplType){
				...
				if (',1101,4401,' == ''){
					var cur_tr = $(this).find('.tbl-except').prev();
					$(cur_tr).find('input[data-field="start"]').attr("value","1");
					$(cur_tr).find('input[data-field="postage"]').val('10');
					$(cur_tr).find('input[data-field="plus"]').val('1');
					$(cur_tr).find('input[data-field="postageplus"]').val('10');
					tag ++;
				}else{
					StartNum +=1;
					cell = RuleCell.replace(/CurNum/g,StartNum);
					...
					$(this).find('.J_ToggleBatch').css('display','').html('批量操作');
					var cur_tr = $(this).find('.tbl-except').find('table').find('tr:last');
					$(cur_tr).find('.area-group>p').html('市辖区,广州市');
					var area = ',1101,4401,';
					area = area.substring(1,area.length-1);
					$(cur_tr).find('input[type="hidden"]').val(area + '|||' + '市辖区,广州市');
					$(cur_tr).find('input[data-field="start"]').val('1');
					$(cur_tr).find('input[data-field="postage"]').val('10');
					$(cur_tr).find('input[data-field="plus"]').val('1');
					$(cur_tr).find('input[data-field="postageplus"]').val('10');
			...
			if ('kd' == tplType){
				...
				if ('' == ''){
					...
					$(this).find('.J_ToggleBatch').css('display','').html('批量操作');
					var cur_tr = $(this).find('.tbl-except').find('table').find('tr:last');
					$(cur_tr).find('.area-group>p').html('全国');
					var area = '';
					area = area.substring(1,area.length-1);
					$(cur_tr).find('input[type="hidden"]').val(area + '|||' + '全国');
					$(cur_tr).find('input[data-field="start"]').val('1');
					$(cur_tr).find('input[data-field="postage"]').val('10');
					$(cur_tr).find('input[data-field="plus"]').val('1');
					$(cur_tr).find('input[data-field="postageplus"]').val('10');
