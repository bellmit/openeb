...
(function () {
    ...
    var URL = basePath+"/static/editor/ueditor/";
    //图片、视频独立服务器地址
    //可指定具体的地址，例如http://www.gtf001.com
    var RESURL = "/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:RESURL                     		//图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,scrawlPath:RESURL                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:RESURL                   			//附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:RESURL                  		//图片修正地址，同imagePath
