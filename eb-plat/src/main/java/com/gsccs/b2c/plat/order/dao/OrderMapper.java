...
public interface OrderMapper {
    ...
    List<Order> selectPageByExample(@Param("sid") Long sid,
			@Param("example") OrderExample example);
    
    Order selectByPrimaryKey(@Param("sid") Long sid, @Param("id") Long id);
    Order selectByOrdersn(@Param("sid") Long sid, @Param("ordersn") String ordersn);
