...
<html>
	...
	function saveDeliverType() {
		...
		alert(staval);
		 $.ajax({
			url : '${pageContext.request.contextPath}/logistics/DeliverTypeEditDo',
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<input type="hidden" name="status" id="status" value="${dt.status}">
												<input type="hidden" name="id" id="id" value="${dt.id}">
												<input type="hidden" name="siteid" id="siteid" value="${dt.siteid}">
											</td>
										</tr>
										<tr>
											<th><em><font color="red">*</font></em>配送方式名称：</th>
											<td><input autocomplete="off" class="x-input " type="text"
												id="title" name="title" maxlength="100" style="width:60%" value="${dt.title}"></td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<input type="hidden" name="hascod" id="hascod" value="${dt.hascod}">
											</td>
										</tr>
										<tr>
											<th>重量设置：</th>
										...
										<tr>
											...
											<td><font  style="color: black;font-size: 12px;">首重费用</font>
												<input type="value" style="width: 100px;" class="x-input " name="firstprice" id="firstprice" value="${dt.firstprice}"/>
												<font  style="color: black;font-size: 12px;">续重费用</font>
												<input type="value" style="width: 100px;"  class="x-input " name="continueprice" id="continueprice" value="${dt.continueprice}">
											</td>
										</tr>
										...
										<tr>
											...
											<td><textarea type="textarea" class="x-input"
													...
													maxth="255" id="dom_el_8bbbb42" value="${dt.content}"></textarea><br />
