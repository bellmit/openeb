...
<body>
	...
	$(function() {
		$('#product_list').datagrid({
			...
			fit : true,//自动大小 
			loadMsg : '数据加载中请稍后……',
			url : '${pageContext.request.contextPath}/product/datagrid?status=1',
			remoteSort : false,
			fitColums : true,
			checkOnSelect : true,
	...
	<div id="product_toolbar">
		<form id="product_searchContent" method="post">
			 ...
			 <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="product_down('2');">下架</a><font color="gray">|</font>
