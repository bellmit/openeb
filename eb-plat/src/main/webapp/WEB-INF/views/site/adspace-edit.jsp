...
<form id="adv_position_form" action="${pageContext.request.contextPath}/adspace/save" method="post">
    <input type="hidden" name="apId" value="${adspace.id }">
    <table class="table tb-type2">
        <tbody>
	        ...
	        <tr class="noborder">
	            ...
	            <input type="text" value="${adspace.title }" name="title" id="apName" maxlength="100" class="txt"></td>
	        ...
	        <tr class="noborder" style="background: rgb(255, 255, 255);">
	            <td class="vatop rowform">
	            <input type="text" value="${adspace.remark }" name="remark" id="apIntro" maxlength="100" class="txt">
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
	        ...
	        <tr>
	        </tr><tr style="background: rgb(255, 255, 255);">
	        ...
	        <tr class="noborder">
                <td class="vatop rowform">
               		<input type="text" value="${adspace.apcode }" name="apcode" id="apKey" maxlength="100" class="txt">
                </td>
	        </tr>
	        <tr>
	        ...
	        <tr class="noborder" style="background: rgb(251, 251, 251);">
	            <td class="vatop rowform">
	            启用：<input type="radio" value="1" name="state" id="isUse" class="radio" checked="">
	            停用：<input type="radio" value="0" name="state" id="isUse" class="radio"></td>
	            <td class="vatop tips"></td>
	        </tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="${adspace.apwidth }" name="apwidth" id="apWidth" class="txt"></td>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="${adspace.apheight }" name="apheight" id="apHeight" class="txt"></td>
	            <td class="vatop tips">请填写数字</td>
	        </tr>
