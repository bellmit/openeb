...
<body>
	...
	<div class="main">
		...
		<div class="content clearfix">
			<a class="Left" href="#" title="国庆大促" target="_blank"><img src="resources/images/index_001.jpg" class="ad-img" width="480"></a>
			<div class="login_form Right" id="JS_loginForm">
				...
				<form action="${pageContext.request.contextPath}/login" method="post">
					...
					<br>
					<p>
						<input id="JS_password" type="password" class="input yahei black" name="password" tabindex="1" maxlength="50" value="123456">
					</p>
					<br>
