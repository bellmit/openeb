...
<div class="page">
    ...
    <form id="store_class_form" method="post" action="http://b2b2c.leimingtech.com/leimingtech-admin/member/grade/update.do">
        <table class="table tb-type2">
            <tbody>
            <input type="hidden" name="gradeId" value="644610a083c04e88ac00105706f3d3dd">
            <tr class="noborder">
                <td colspan="2" class="required"><label class="validation" for="gradeName">等级名称:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" value="银牌会员" name="gradeName" id="gradeName" class="txt"></td>
            ...
            <tr class="noborder" style="background: rgb(255, 255, 255);">
                <td class="vatop rowform"><input type="text" value="1000" name="integration" id="integration" class="txt"></td>
                <td class="vatop tips"></td>
            </tr>
            ...
            <tr class="noborder" style="background: rgb(255, 255, 255);">
                <td class="vatop rowform"><input type="text" value="95" name="preferential" id="preferential" class="txt">%</td>
            ...
            <tr class="noborder" style="background: rgb(255, 255, 255);">
                ...
                <td class="vatop tips">
                	<img id="imgView" src="./管理后台-会员等级删除_files/1458808632777.png" style="width: 100px;height:100px;">
                	<input type="hidden" name="gradeImg" value="/upload/img/membergrade/1458808632777.png">
                </td>
            </tr>
