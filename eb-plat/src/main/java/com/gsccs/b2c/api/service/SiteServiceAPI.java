...
public class SiteServiceAPI implements TempletServiceI{
	...
	public List<FileTreeGrid> getTempleByStoreId(Long storeId){
		SiteTemplet storeTemplet = new SiteTemplet();
		storeTemplet.setStoreid(storeId);
		List<SiteTemplet> stList = storeTempletService.find(storeTemplet, "");
