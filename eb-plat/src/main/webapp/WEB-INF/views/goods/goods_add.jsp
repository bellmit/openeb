...
<head>
	...
	<link href="${pageContext.request.contextPath}/static/kindeditor/themes/default/default.css" rel="stylesheet"></head>
<body>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-store/js/ajaxfileupload/ajaxfileupload.js" charset="utf-8"></script>
...
<script type="text/javascript">
APP_BASE = '${pageContext.request.contextPath}';
</script>
...
function insert_img(name,url){
	...
	$.getScript("${pageContext.request.contextPath}/static/jquery-store/js/store_goods.js");
...
//            },
        ...
        messages : {
            ...
            goods_cost_price : {
                number     : '成本价只能是数字',
                min		   : '成本价必须是0.01~1000000之间的数字',
                max		   : '成本价必须是0.01~1000000之间的数字'
            },
            price : {	
				required   : '价格不为空',
                number     : '只能数字',
    ...
    <form method="post" id="goods_form" action="#">
      ...
      <div class="goods-attribute" style="width: 98%;">
        ...
        <dl>
          <dt>商品分类：</dt>
          <dd id="gcategory">
            <span class="f_l">${category.title }</span> 
          	<a class="edit_gcategory ncu-btn1 ml10" href="${pageContext.request.contextPath}/goods/checkcate"><span>编辑</span></a>
            <input type="text" id="cate_id" name="cate_id" value="${category.id }" class="mls_id text">
            <input type="hidden" name="cate_name" id="cate_name" value="${category.title }" class="mls_names text">
          </dd>
        </dl>
        <dl>
          <dt>商品类型：</dt>
          <dd>
            <p>
              <label style="padding-right:8px;">
                <input name="goods_form" value="1" checked="checked" type="radio">全新</label>
              <label><input name="goods_form" value="2" type="radio">二手</label>
            </p>
          </dd>
        </dl>
        <dl>
          ...
          <dd>
            <p>
              <input name="goods_name" id="goods_name" type="text" class="text w400" title="" value="">
            </p><p>
        ...
        <dl nc_type="spec_dl" class="spec-bg" style="display:none">
	        <dt>库存配置：</dt>
	        <dd class="spec-dd" style="padding: 0px;">
		        <table border="0" cellpadding="0" cellspacing="0" class="spec_table" style="padding: 0px;margin: 0px;">
			        <thead>
						<tr>
						<c:forEach items="${type.specs }" var="spec" varStatus="status">
	                    <th>${spec.title }</th> 
       ...
       <dl>
        	...
        	<dd>
        		<div class="pic_list">
	                ...
	                <div class="content">
	                	...
	                	<div class="standard">
	                		<div>
	                			<ul style="height: 130px;overflow:auto;overflow-x: hidden;" id="photoView01" class="gbin1-list ui-sortable">
        ...
        <dl>
          ...
          <dd>
            <p>
              <textarea id="goods_body" name="goods_body" style="width: 100%; height: 400px; visibility: hidden; display: none;"></textarea>
	            </p>
                ...
                <li>
                  ...
                  <div id="Postage" style="display:none">
                    <div class="freight-template">
                    		运费模板
                      <input onclick="window.open('/leimingtech-admin/platform/transport/index')" type="button" value="查看我的运费模板" class="select-templ" id="postageButton">
                    </div>
                  </div>
                </li>
              </ul>
...
function ajaxTypeImageUploads(myBlogImage,views){
	     $.ajaxFileUpload({
	        ...
	        url:"${pageContext.request.contextPath}/upload/imageFileUpload",
...
function ajaxFileUploads(imageid,ob,imgDiv,type) {
	var $obj = $(ob);
    $.ajaxFileUpload({
        url: '${pageContext.request.contextPath}/upload/goodsImage',
        data: '',
        secureuri: false,
...
$(function(){
	$("#btn-sub").click(function(){
		...
		if($('#goods_form').valid()){
			...
			var url = APP_BASE+"/goods/addsave";
	        //加载进度条
	        layer.load(2, {
...
function ok(goodsShow){
	window.location.href='${pageContext.request.contextPath}/goods/sellList';
}
</script>
<script type="text/javascript">
//买家承担运费&运费模板
			...
			for(var s = 0; s < arr.length; s++){
				...
				//判断是否已经存在tr
					...
					if(flg){
						var tr = '<tr name="skuDo" spId='+arr[s].spId+' spName='+arr[s].spName+' specValueName='+arr[s].specValueName+' specValueId="'+arr[s].specValueId+'" value="'+arr[s].specValueId+'">'+
						str+
		    			'<td><input class="text" name="price" type="text" value="' + goodsPrice + '"/></td>'+
