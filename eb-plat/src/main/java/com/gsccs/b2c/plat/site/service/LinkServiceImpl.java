...
import com.gsccs.b2c.plat.site.dao.LinkMapper;
import com.gsccs.b2c.plat.site.model.LinkExample;
import com.gsccs.b2c.plat.site.model.LinkExample.Criteria;
...
public class LinkServiceImpl implements LinkService {
	...
	public List<Link> find(Link link, String order, int currPage, int pageSize) {
		...
		List<Link> listLink= linkMapper.selectPageByExample(example);
		for(Link linkT:listLink){
	...
	//获取分类列表
	public void proSearchParamAll(Link link, Criteria criteria) {
