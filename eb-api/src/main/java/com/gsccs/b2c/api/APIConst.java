...
public abstract class APIConst {
	...
	/** 商家不存在 **/
	public static final String ERROR_CODE_0002 = "error0002";
	public static final String ERROR_MSG_0002 = "商家不存在";
	
	/** 订单不存在 **/
	public static final String ERROR_CODE_0003 = "error0003";
	public static final String ERROR_MSG_0003 = "订单不存在";
