...
public class ReturnOrder extends DomainObject{
    /**
	 * 
	 */
    ...
    private String backmoneystatusStr;
	...
	public String getBackmoneystatusStr() {
		if(APIConst.RETURNORDER_BUYER_APPLY.equals(backmoneystatus)){
			backmoneystatusStr="审核处理退款";
		}else if(APIConst.RETURNORDER_SELLER_AGREE_REFUND.equals(backmoneystatus)){
			backmoneystatusStr="卖家审核通过,同意退货";
		}else if(APIConst.RETURNORDER_BUYER_REFUND.equals(backmoneystatus)){
			backmoneystatusStr="买家已发货,卖家确认收货";
		}else if(APIConst.RETURNORDER_SELLER_AGREE_MOMEY.equals(backmoneystatus)){
			backmoneystatusStr="已退款";
		}
		return backmoneystatusStr;
	}

	public void setBackmoneystatusStr(String backmoneystatusStr) {
		this.backmoneystatusStr = backmoneystatusStr;
	}
