...
<html>
	...
	<link href="${pageContext.request.contextPath}/static/ui-v2/font-awesome.min.css" rel="stylesheet">
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/ui-v2/common_select.js" charset="utf-8"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/ui-v2/dialog.js" id="dialog_js" charset="utf-8"></script>
	<link href="${pageContext.request.contextPath}/static/ui-v2/dialog.css" rel="stylesheet" type="text/css">
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="${pageContext.request.contextPath}/transport/form"><span>新增模板</span></a></li>
            </ul>
        </div>
    </div>
				...
				<div id="J_TemplateList" class="manage-list">
					<div class="section J_Section">
						<div class="tbl-prefix">
							<span class="meta"> 最后编辑：<span class="J_LastModified"></span> 
							<a href="${pageContext.request.contextPath}/transport/form?id=b2d265f74c884aba97cbcaefd68d41c1">编辑</a> | 
...
快递													</td>
		...
		$(function(){	
			$('a[class="J_Delete"]').click(function(){
				...
				if (confirm('确认删除此模板?')){
					var url = '${pageContext.request.contextPath}/transport/delete';
					var args = {"id":id};
		...
		function setDefTran(tranId){
			var url = "${pageContext.request.contextPath}/transport/setDefault"
			var args = {"id":tranId};
			$.post(url, args, function(data){
				if(data == "success"){
		...
		function ok(){
			window.location.href = '${pageContext.request.contextPath}/transport';
		}
		</script>
</div>
