...
<div class="fixed-bar">
    <div class="item-title">
        <h3>广告管理</h3>
        <ul class="tab-base">
            <li><a href="${pageContext.request.contextPath}/advert"><span>管理</span></a></li>
            <li><a href="javascript:void(0)" class="current"><span>新增</span></a></li>
        </ul>
    </div>
</div>
<div class="fixed-empty"></div>
<form id="adv_form" action="${pageContext.request.contextPath}/advert/save" method="post">
    ...
    <table class="table tb-type2">
        <tbody>
	        ...
	        <tr class="noborder" style="background: rgb(255, 255, 255);">
	            <td class="vatop rowform">
	            <input type="text" value="" name="advTitle" id="advTitle" maxlength="100" class="txt"></td>
	            <td class="vatop tips"></td>
	        </tr>
	      <tr>
	        ...
	        <tr class="noborder" style="background: rgb(251, 251, 251);">
	            <td class="vatop rowform">
					<input type="hidden" name="resUrl" id="resUrl" value="" class="type-file-text">
	               	<input name="myfiles" id="myfiles" type="file" multiple="multiple" onchange="ajaxFileUploads('myfiles','resUrl');">
	                <img id="resUrl" name="resUrl" height="300px" width="300px" src="${pageContext.request.contextPath}/static/ui-v2/images/nopic.png">
	            </td>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	            <input type="text" value="" name="advUrl" id="advUrl" maxlength="100" class="txt">
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" class="txt Wdate" value="" name="startTime1" id="startTime" onclick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'});"></td>
	           <td class="vatop tips"></td>
	        </tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	            	<input type="text" class="txt Wdate" name="endTime1" id="endTime" onclick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'});">
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
...
<script>
  ...
  //上传图片
	...
	//删除
	function reMove(){
		$("img[id='resUrl']").attr("src", "${pageContext.request.contextPath}/static/ui-v2/images/nopic.png");
    	$("#resUrl").val("");
	}
</script>
</body>
