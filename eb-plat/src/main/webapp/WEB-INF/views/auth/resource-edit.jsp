...
<body>
	<form id="resource_form" action="" method="post">
		...
		<table cellspacing="0" cellpadding="0">
			...
			<tr class="thclass" style="height: 40px">
				<th style="width: 130px;">资源路径<font style="color: red">*</font></th>
			...
			<tr class="thclass" style="height: 40px">
					<th style="width: 130px;">权限字符串<font style="color: red">*</font></th>
					<td><input type="text" name="permission" class="easyui-validatebox"
						required="true" missingMessage="不能为空"
