...
<html>
	...
	<link href="${pageContext.request.contextPath}/static/jquery-store/css/font-awesome.min.css" rel="stylesheet">
	<script type="text/javascript" src=${pageContext.request.contextPath}/static/ui-v2/common_select.js" charset="utf-8"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/ui-v2/dialog.js" id="dialog_js" charset="utf-8"></script><link href="./管理后台-物流工具新增模板_files/dialog.css" rel="stylesheet" type="text/css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/ui-v2/dialog.css">
	...
	<link href="${pageContext.request.contextPath}/static/jquery-store/css/transport.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-store/js/transport_class_zh_CN.js" charset="utf-8"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-store/js/transport.js" charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>运费模板</h3>
            <ul class="tab-base">
                <li><a href="${pageContext.request.contextPath}/transport"><span>所有模板</span></a></li>
			...
			<div class="wrap" style="width: 98%;">
				<div class="tabmenu">
					<ul class="tab pngFix">
						<li class="active"><a href="${pageContext.request.contextPath}/transport/index">运费模板</a></li>
					</ul>
				</div>
				<div class="ncu-form-style">
					...
					<form method="post" id="tpl_form" name="tpl_form" action="javascript:void(0);">
							...
							<ul>
								...
								<input type="text" class="text" autocomplete="off" value="" name="title" style="height: 18px;width: 123px; margin-top: 0px;">
									<p class="msg" style="display: none" error_type="title">
										<span class="error">模板名称不能为空</span>
									</p>
								</li>
								<li class="form-elem express"><span class="label-like">运送方式：：</span>
									...
									<p class="msg" style="display: none" error_type="trans_type">
										<span class="error">请选择需要操作的数据</span>
									</p>
								</li>
							</ul>
						</div>
						...
						<div class="trans-submit">
							<input type="submit" id="submit_tpl" class="submit" value="提交">
						</div>
					</form>
